        ...
        for eachRule in requiredRule {
            ...
            case .lowerCase:
                if containingRule.contains(eachRule) {
                    ...
                    requiredString = "Must have at least one lowercase letter"
            ...
            case .uppercase:
                if containingRule.contains(eachRule) {
                    ...
                    requiredString = "Must have at least one uppercase letter"
                    return requiredString
                }
            ...
            case .digit:
                if containingRule.contains(eachRule) {
                    ...
                    requiredString = "Must have at least one digit"
                    return requiredString
                }
            ...
            case .oneUniqueCharacter:
                if containingRule.contains(eachRule) {
                    ...
                    requiredString = "Must have at least one unique character"
                    return requiredString
                }
            ...
            case .specialCharacter:
                if containingRule.contains(eachRule) {
                    ...
                    requiredString = "Must have at least one special character"
                    return requiredString
                }
            case .minmumLength:
                if containingRule.contains(eachRule) {
